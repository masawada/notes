...
var NoteSyncPlugin = class extends import_obsidian.Plugin {
  ...
  scheduleSync() {
    ...
    this.syncTimer = setTimeout(() => this.sync(), 3e4);
  }
  async sync() {
    if (this.isSyncing) {
